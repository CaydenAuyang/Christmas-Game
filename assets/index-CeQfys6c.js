 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var $p;function S_(){if($p)return Zo;$p=1;var s=nh(),e=Symbol.for("react.element"),t=Symbol.for("react.fragment"),i=Object.prototype.hasOwnProperty,o=s.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner,l={key:!0,ref:!0,__self:!0,__source:!0};function u(f,p,h){var m,d={},_=null,y=null;h!==void 0&&(_=""+h),p.key!==void 0&&(_=""+p.key),p.ref!==void 0&&(y=p.ref);for(m in p)i.call(p,m)&&!l.hasOwnProperty(m)&&(d[m]=p[m]);if(f&&f.defaultProps)for(m in p=f.defaultProps,p)d[m]===void 0&&(d[m]=p[m]);return{$$typeof:e,type:f,key:_,ref:y,props:d,_owner:o.current}}return Zo.Fragment=t,Zo.jsx=u,Zo.jsxs=u,Zo}var Xp;function M_(){return Xp||(Xp=1,Xu.exports=S_()),Xu.exports}var He=M_(),hi=nh();const w_=Kg(hi);var wl={},ju={exports:{}},Wn={},Yu={exports:{}},Ku={};/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var qp;function E_(){return qp||(qp=1,(function(s){function e(G,ue){var ee=G.length;G.push(ue);e:for(;0<ee;){var z=ee-1>>>1,le=G[z];if(0<o(le,ue))G[z]=ue,G[ee]=le,ee=z;else break e}}function t(G){return G.length===0?null:G[0]}function i(G){if(G.length===0)return null;var ue=G[0],ee=G.pop();if(ee!==ue){G[0]=ee;e:for(var z=0,le=G.length,Ve=le>>>1;z<Ve;){var re=2*(z+1)-1,ye=G[re],Re=re+1,Ee=G[Re];if(0>o(ye,ee))Re<le&&0>o(Ee,ye)?(G[z]=Ee,G[Re]=ee,z=Re):(G[z]=ye,G[re]=ee,z=re);else if(Re<le&&0>o(Ee,ee))G[z]=Ee,G[Re]=ee,z=Re;else break e}}return ue}function o(G,ue){var ee=G.sortIndex-ue.sortIndex;return ee!==0?ee:G.id-ue.id}if(typeof performance=="object"&&typeof performance.now=="function"){var l=performance;s.unstable_now=function(){return l.now()}}else{var u=Date,f=u.now();s.unstable_now=function(){return u.now()-f}}var p=[],h=[],m=1,d=null,_=3,y=!1,w=!1,E=!1,x=typeof setTimeout=="function"?setTimeout:null,S=typeof clearTimeout=="function"?clearTimeout:null,R=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function P(G){for(var ue=t(h);ue!==null;){if(ue.callback===null)i(h);else if(ue.startTime<=G)i(h),ue.sortIndex=ue.expirationTime,e(p,ue);else break;ue=t(h)}}function D(G){if(E=!1,P(G),!w)if(t(p)!==null)w=!0,_e(V);else{var ue=t(h);ue!==null&&de(D,ue.startTime-G)}}function V(G,ue){w=!1,E&&(E=!1,S(q),q=-1),y=!0;var ee=_;try{for(P(ue),d=t(p);d!==null&&(!(d.expirationTime>ue)||G&&!ne());){var z=d.callback;if(typeof z=="function"){d.callback=null,_=d.priorityLevel;var le=z(d.expirationTime<=ue);ue=s.unstable_now(),typeof le=="function"?d.callback=le:d===t(p)&&i(p),P(ue)}else i(p);d=t(p)}if(d!==null)var Ve=!0;else{var re=t(h);re!==null&&de(D,re.startTime-ue),Ve=!1}return Ve}finally{d=null,_=ee,y=!1}}var O=!1,F=null,q=-1,U=5,L=-1;function ne(){return!(s.unstable_now()-L<U)}function ae(){if(F!==null){var G=s.unstable_now();L=G;var ue=!0;try{ue=F(!0,G)}finally{ue?j():(O=!1,F=null)}}else O=!1}var j;if(typeof R=="function")j=function(){R(ae)};else if(typeof MessageChannel<"u"){var oe=new MessageChannel,he=oe.port2;oe.port1.onmessage=ae,j=function(){he.postMessage(null)}}else j=function(){x(ae,0)};function _e(G){F=G,O||(O=!0,j())}function de(G,ue){q=x(function(){G(s.unstable_now())},ue)}s.unstable_IdlePriority=5,s.unstable_ImmediatePriority=1,s.unstable_LowPriority=4,s.unstable_NormalPriority=3,s.unstable_Profiling=null,s.unstable_UserBlockingPriority=2,s.unstable_cancelCallback=function(G){G.callback=null},s.unstable_continueExecution=function(){w||y||(w=!0,_e(V))},s.unstable_forceFrameRate=function(G){0>G||125<G?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):U=0<G?Math.floor(1e3/G):5},s.unstable_getCurrentPriorityLevel=function(){return _},s.unstable_getFirstCallbackNode=function(){return t(p)},s.unstable_next=function(G){switch(_){case 1:case 2:case 3:var ue=3;break;default:ue=_}var ee=_;_=ue;try{return G()}finally{_=ee}},s.unstable_pauseExecution=function(){},s.unstable_requestPaint=function(){},s.unstable_runWithPriority=function(G,ue){switch(G){case 1:case 2:case 3:case 4:case 5:break;default:G=3}var ee=_;_=G;try{return ue()}finally{_=ee}},s.unstable_scheduleCallback=function(G,ue,ee){var z=s.unstable_now();switch(typeof ee=="object"&&ee!==null?(ee=ee.delay,ee=typeof ee=="number"&&0<ee?z+ee:z):ee=z,G){case 1:var le=-1;break;case 2:le=250;break;case 5:le=1073741823;break;case 4:le=1e4;break;default:le=5e3}return le=ee+le,G={id:m++,callback:ue,priorityLevel:G,startTime:ee,expirationTime:le,sortIndex:-1},ee>z?(G.sortIndex=ee,e(h,G),t(p)===null&&G===t(h)&&(E?(S(q),q=-1):E=!0,de(D,ee-z))):(G.sortIndex=le,e(p,G),w||y||(w=!0,_e(V))),G},s.unstable_shouldYield=ne,s.unstable_wrapCallback=function(G){var ue=_;return function(){var ee=_;_=ue;try{return G.apply(this,arguments)}finally{_=ee}}}})(Ku)),Ku}var jp;function T_(){return jp||(jp=1,Yu.exports=E_()),Yu.exports}/**
 * @license React
...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Ur,depthTest:!1,depthWrite:!1})}function tg(){return new zr({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:ch(),fragmentShader:`
		...
		`,blending:Ur,depthTest:!1,depthWrite:!1})}function ng(){return new zr({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:ch(),fragmentShader:`
	...
	`}function dw(s){let e=new WeakMap,t=null;function i(f){if(f&&f.isTexture){const p=f.mapping,h=p===jf||p===Yf,m=p===fo||p===ho;if(h||m){let d=e.get(f);const _=d!==void 0?d.texture.pmremVersion:0;if(f.isRenderTargetTexture&&f.pmremVersion!==_)return t===null&&(t=new Qm(s)),d=h?t.fromEquirectangular(f,d):t.fromCubemap(f,d),d.texture.pmremVersion=f.pmremVersion,e.set(f,d),d.texture;if(d!==void 0)return d.texture;{const y=f.image;return h&&y&&y.height>0||m&&y&&o(y)?(t===null&&(t=new Qm(s)),d=h?t.fromEquirectangular(f):t.fromCubemap(f),d.texture.pmremVersion=f.pmremVersion,e.set(f,d),f.addEventListener("dispose",l),d.texture):null}}}return f}function o(f){let p=0;const h=6;for(let m=0;m<h;m++)f[m]!==void 0&&p++;return p===h}function l(f){const p=f.target;p.removeEventListener("dispose",l);const h=e.get(p);h!==void 0&&(e.delete(p),h.dispose())}function u(){e=new WeakMap,t!==null&&(t.dispose(),t=null)}return{get:i,dispose:u}}function pw(s){const e={};function t(i){if(e[i]!==void 0)return e[i];let o;switch(i){case"WEBGL_depth_texture":o=s.getExtension("WEBGL_depth_texture")||s.getExtension("MOZ_WEBGL_depth_texture")||s.getExtension("WEBKIT_WEBGL_depth_texture");break;case"EXT_texture_filter_anisotropic":o=s.getExtension("EXT_texture_filter_anisotropic")||s.getExtension("MOZ_EXT_texture_filter_anisotropic")||s.getExtension("WEBKIT_EXT_texture_filter_anisotropic");break;case"WEBGL_compressed_texture_s3tc":o=s.getExtension("WEBGL_compressed_texture_s3tc")||s.getExtension("MOZ_WEBGL_compressed_texture_s3tc")||s.getExtension("WEBKIT_WEBGL_compressed_texture_s3tc");break;case"WEBGL_compressed_texture_pvrtc":o=s.getExtension("WEBGL_compressed_texture_pvrtc")||s.getExtension("WEBKIT_WEBGL_compressed_texture_pvrtc");break;default:o=s.getExtension(i)}return e[i]=o,o}return{has:function(i){return t(i)!==null},init:function(){t("EXT_color_buffer_float"),t("WEBGL_clip_cull_distance"),t("OES_texture_float_linear"),t("EXT_color_buffer_half_float"),t("WEBGL_multisampled_render_to_texture"),t("WEBGL_render_shared_exponent")},get:function(i){const o=t(i);return o===null&&console.warn("THREE.WebGLRenderer: "+i+" extension not supported."),o}}}function mw(s,e,t,i){const o={},l=new WeakMap;function u(d){const _=d.target;_.index!==null&&e.remove(_.index);for(const w in _.attributes)e.remove(_.attributes[w]);for(const w in _.morphAttributes){const E=_.morphAttributes[w];for(let x=0,S=E.length;x<S;x++)e.remove(E[x])}_.removeEventListener("dispose",u),delete o[_.id];const y=l.get(_);y&&(e.remove(y),l.delete(_)),i.releaseStatesOfGeometry(_),_.isInstancedBufferGeometry===!0&&delete _._maxInstanceCount,t.memory.geometries--}function f(d,_){return o[_.id]===!0||(_.addEventListener("dispose",u),o[_.id]=!0,t.memory.geometries++),_}function p(d){const _=d.attributes;for(const w in _)e.update(_[w],s.ARRAY_BUFFER);const y=d.morphAttributes;for(const w in y){const E=y[w];for(let x=0,S=E.length;x<S;x++)e.update(E[x],s.ARRAY_BUFFER)}}function h(d){const _=[],y=d.index,w=d.attributes.position;let E=0;if(y!==null){const R=y.array;E=y.version;for(let P=0,D=R.length;P<D;P+=3){const V=R[P+0],O=R[P+1],F=R[P+2];_.push(V,O,O,F,F,V)}}else if(w!==void 0){const R=w.array;E=w.version;for(let P=0,D=R.length/3-1;P<D;P+=3){const V=P+0,O=P+1,F=P+2;_.push(V,O,O,F,F,V)}}else return;const x=new(c0(_)?m0:p0)(_,1);x.version=E;const S=l.get(d);S&&e.remove(S),l.set(d,x)}function m(d){const _=l.get(d);if(_){const y=d.index;y!==null&&_.version<y.version&&h(d)}else h(d);return l.get(d)}return{get:f,update:p,getWireframeAttribute:m}}function gw(s,e,t){let i;function o(_){i=_}let l,u;function f(_){l=_.type,u=_.bytesPerElement}function p(_,y){s.drawElements(i,y,l,_*u),t.update(y,i,1)}function h(_,y,w){w!==0&&(s.drawElementsInstanced(i,y,l,_*u,w),t.update(y,i,w))}function m(_,y,w){if(w===0)return;const E=e.get("WEBGL_multi_draw");if(E===null)for(let x=0;x<w;x++)this.render(_[x]/u,y[x]);else{E.multiDrawElementsWEBGL(i,y,0,l,_,0,w);let x=0;for(let S=0;S<w;S++)x+=y[S];t.update(x,i,1)}}function d(_,y,w,E){if(w===0)return;const x=e.get("WEBGL_multi_draw");if(x===null)for(let S=0;S<_.length;S++)h(_[S]/u,y[S],E[S]);else{x.multiDrawElementsInstancedWEBGL(i,y,0,l,_,0,E,0,w);let S=0;for(let R=0;R<w;R++)S+=y[R];for(let R=0;R<E.length;R++)t.update(S,i,E[R])}}this.setMode=o,this.setIndex=f,this.render=p,this.renderInstances=h,this.renderMultiDraw=m,this.renderMultiDrawInstances=d}function vw(s){const e={geometries:0,textures:0},t={frame:0,calls:0,triangles:0,points:0,lines:0};function i(l,u,f){switch(t.calls++,u){case s.TRIANGLES:t.triangles+=f*(l/3);break;case s.LINES:t.lines+=f*(l/2);break;case s.LINE_STRIP:t.lines+=f*(l-1);break;case s.LINE_LOOP:t.lines+=f*l;break;case s.POINTS:t.points+=f*l;break;default:console.error("THREE.WebGLInfo: Unknown draw mode:",u);break}}function o(){t.calls=0,t.triangles=0,t.points=0,t.lines=0}return{memory:e,render:t,programs:null,autoReset:!0,reset:o,update:i}}function _w(s,e,t){const i=new WeakMap,o=new Kt;function l(u,f,p){const h=u.morphTargetInfluences,m=f.morphAttributes.position||f.morphAttributes.normal||f.morphAttributes.color,d=m!==void 0?m.length:0;let _=i.get(f);if(_===void 0||_.count!==d){let L=function(){q.dispose(),i.delete(f),f.removeEventListener("dispose",L)};var y=L;_!==void 0&&_.texture.dispose();const w=f.morphAttributes.position!==void 0,E=f.morphAttributes.normal!==void 0,x=f.morphAttributes.color!==void 0,S=f.morphAttributes.position||[],R=f.morphAttributes.normal||[],P=f.morphAttributes.color||[];let D=0;w===!0&&(D=1),E===!0&&(D=2),x===!0&&(D=3);let V=f.attributes.position.count*D,O=1;V>e.maxTextureSize&&(O=Math.ceil(V/e.maxTextureSize),V=e.maxTextureSize);const F=new Float32Array(V*O*4*d),q=new f0(F,V,O,d);q.type=Nr,q.needsUpdate=!0;const U=D*4;for(let ne=0;ne<d;ne++){const ae=S[ne],j=R[ne],oe=P[ne],he=V*O*4*ne;for(let _e=0;_e<ae.count;_e++){const de=_e*U;w===!0&&(o.fromBufferAttribute(ae,_e),F[he+de+0]=o.x,F[he+de+1]=o.y,F[he+de+2]=o.z,F[he+de+3]=0),E===!0&&(o.fromBufferAttribute(j,_e),F[he+de+4]=o.x,F[he+de+5]=o.y,F[he+de+6]=o.z,F[he+de+7]=0),x===!0&&(o.fromBufferAttribute(oe,_e),F[he+de+8]=o.x,F[he+de+9]=o.y,F[he+de+10]=o.z,F[he+de+11]=oe.itemSize===4?o.w:1)}}_={count:d,texture:q,size:new Xe(V,O)},i.set(f,_),f.addEventListener("dispose",L)}if(u.isInstancedMesh===!0&&u.morphTexture!==null)p.getUniforms().setValue(s,"morphTexture",u.morphTexture,t);else{let w=0;for(let x=0;x<h.length;x++)w+=h[x];const E=f.morphTargetsRelative?1:1-w;p.getUniforms().setValue(s,"morphTargetBaseInfluence",E),p.getUniforms().setValue(s,"morphTargetInfluences",h)}p.getUniforms().setValue(s,"morphTargetsTexture",_.texture,t),p.getUniforms().setValue(s,"morphTargetsTextureSize",_.size)}return{update:l}}function yw(s,e,t,i){let o=new WeakMap;function l(p){const h=i.render.frame,m=p.geometry,d=e.get(p,m);if(o.get(d)!==h&&(e.update(d),o.set(d,h)),p.isInstancedMesh&&(p.hasEventListener("dispose",f)===!1&&p.addEventListener("dispose",f),o.get(p)!==h&&(t.update(p.instanceMatrix,s.ARRAY_BUFFER),p.instanceColor!==null&&t.update(p.instanceColor,s.ARRAY_BUFFER),o.set(p,h))),p.isSkinnedMesh){const _=p.skeleton;o.get(_)!==h&&(_.update(),o.set(_,h))}return d}function u(){o=new WeakMap}function f(p){const h=p.target;h.removeEventListener("dispose",f),t.remove(h.instanceMatrix),h.instanceColor!==null&&t.remove(h.instanceColor)}return{update:l,dispose:u}}class S0 extends On{constructor(e,t,i,o,l,u,f,p,h,m){if(m=m!==void 0?m:co,m!==co&&m!==ma)throw new Error("DepthTexture format must be either THREE.DepthFormat or THREE.DepthStencilFormat");i===void 0&&m===co&&(i=po),i===void 0&&m===ma&&(i=ya),super(null,o,l,u,f,p,m,i,h),this.isDepthTexture=!0,this.image={width:e,height:t},this.magFilter=f!==void 0?f:di,this.minFilter=p!==void 0?p:di,this.flipY=!1,this.generateMipmaps=!1,this.compareFunction=null}copy(e){return super.copy(e),this.compareFunction=e.compareFunction,this}toJSON(e){const t=super.toJSON(e);return this.compareFunction!==null&&(t.compareFunction=this.compareFunction),t}}const M0=new On,w0=new S0(1,1);w0.compareFunction=l0;const E0=new f0,T0=new sx,A0=new _0,ig=[],rg=[],sg=new Float32Array(16),og=new Float32Array(9),ag=new Float32Array(4);function _o(s,e,t){const i=s[0];if(i<=0||i>0)return s;const o=e*t;let l=ig[o];if(l===void 0&&(l=new Float32Array(o),ig[o]=l),e!==0){i.toArray(l,0);for(let u=1,f=0;u!==e;++u)f+=t,s[u].toArray(l,f)}return l}function dn(s,e){if(s.length!==e.length)return!1;for(let t=0,i=s.length;t<i;t++)if(s[t]!==e[t])return!1;return!0}function pn(s,e){for(let t=0,i=e.length;t<i;t++)s[t]=e[t]}function fc(s,e){let t=rg[e];t===void 0&&(t=new Int32Array(e),rg[e]=t);for(let i=0;i!==e;++i)t[i]=s.allocateTextureUnit();return t}function xw(s,e){const t=this.cache;t[0]!==e&&(s.uniform1f(this.addr,e),t[0]=e)}function Sw(s,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(s.uniform2f(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(dn(t,e))return;s.uniform2fv(this.addr,e),pn(t,e)}}function Mw(s,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(s.uniform3f(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else if(e.r!==void 0)(t[0]!==e.r||t[1]!==e.g||t[2]!==e.b)&&(s.uniform3f(this.addr,e.r,e.g,e.b),t[0]=e.r,t[1]=e.g,t[2]=e.b);else{if(dn(t,e))return;s.uniform3fv(this.addr,e),pn(t,e)}}function ww(s,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(s.uniform4f(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(dn(t,e))return;s.uniform4fv(this.addr,e),pn(t,e)}}function Ew(s,e){const t=this.cache,i=e.elements;if(i===void 0){if(dn(t,e))return;s.uniformMatrix2fv(this.addr,!1,e),pn(t,e)}else{if(dn(t,i))return;ag.set(i),s.uniformMatrix2fv(this.addr,!1,ag),pn(t,i)}}function Tw(s,e){const t=this.cache,i=e.elements;if(i===void 0){if(dn(t,e))return;s.uniformMatrix3fv(this.addr,!1,e),pn(t,e)}else{if(dn(t,i))return;og.set(i),s.uniformMatrix3fv(this.addr,!1,og),pn(t,i)}}function Aw(s,e){const t=this.cache,i=e.elements;if(i===void 0){if(dn(t,e))return;s.uniformMatrix4fv(this.addr,!1,e),pn(t,e)}else{if(dn(t,i))return;sg.set(i),s.uniformMatrix4fv(this.addr,!1,sg),pn(t,i)}}function Cw(s,e){const t=this.cache;t[0]!==e&&(s.uniform1i(this.addr,e),t[0]=e)}function Rw(s,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(s.uniform2i(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(dn(t,e))return;s.uniform2iv(this.addr,e),pn(t,e)}}function Pw(s,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(s.uniform3i(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(dn(t,e))return;s.uniform3iv(this.addr,e),pn(t,e)}}function bw(s,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(s.uniform4i(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(dn(t,e))return;s.uniform4iv(this.addr,e),pn(t,e)}}function Lw(s,e){const t=this.cache;t[0]!==e&&(s.uniform1ui(this.addr,e),t[0]=e)}function Dw(s,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(s.uniform2ui(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(dn(t,e))return;s.uniform2uiv(this.addr,e),pn(t,e)}}function Iw(s,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(s.uniform3ui(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(dn(t,e))return;s.uniform3uiv(this.addr,e),pn(t,e)}}function Nw(s,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(s.uniform4ui(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(dn(t,e))return;s.uniform4uiv(this.addr,e),pn(t,e)}}function Uw(s,e,t){const i=this.cache,o=t.allocateTextureUnit();i[0]!==o&&(s.uniform1i(this.addr,o),i[0]=o);const l=this.type===s.SAMPLER_2D_SHADOW?w0:M0;t.setTexture2D(e||l,o)}function Ow(s,e,t){const i=this.cache,o=t.allocateTextureUnit();i[0]!==o&&(s.uniform1i(this.addr,o),i[0]=o),t.setTexture3D(e||T0,o)}function Fw(s,e,t){const i=this.cache,o=t.allocateTextureUnit();i[0]!==o&&(s.uniform1i(this.addr,o),i[0]=o),t.setTextureCube(e||A0,o)}function kw(s,e,t){const i=this.cache,o=t.allocateTextureUnit();i[0]!==o&&(s.uniform1i(this.addr,o),i[0]=o),t.setTexture2DArray(e||E0,o)}function zw(s){switch(s){case 5126:return xw;case 35664:return Sw;case 35665:return Mw;case 35666:return ww;case 35674:return Ew;case 35675:return Tw;case 35676:return Aw;case 5124:case 35670:return Cw;case 35667:case 35671:return Rw;case 35668:case 35672:return Pw;case 35669:case 35673:return bw;case 5125:return Lw;case 36294:return Dw;case 36295:return Iw;case 36296:return Nw;case 35678:case 36198:case 36298:case 36306:case 35682:return Uw;case 35679:case 36299:case 36307:return Ow;case 35680:case 36300:case 36308:case 36293:return Fw;case 36289:case 36303:case 36311:case 36292:return kw}}function Bw(s,e){s.uniform1fv(this.addr,e)}function Hw(s,e){const t=_o(e,this.size,2);s.uniform2fv(this.addr,t)}function Vw(s,e){const t=_o(e,this.size,3);s.uniform3fv(this.addr,t)}function Gw(s,e){const t=_o(e,this.size,4);s.uniform4fv(this.addr,t)}function Ww(s,e){const t=_o(e,this.size,4);s.uniformMatrix2fv(this.addr,!1,t)}function $w(s,e){const t=_o(e,this.size,9);s.uniformMatrix3fv(this.addr,!1,t)}function Xw(s,e){const t=_o(e,this.size,16);s.uniformMatrix4fv(this.addr,!1,t)}function qw(s,e){s.uniform1iv(this.addr,e)}function jw(s,e){s.uniform2iv(this.addr,e)}function Yw(s,e){s.uniform3iv(this.addr,e)}function Kw(s,e){s.uniform4iv(this.addr,e)}function Jw(s,e){s.uniform1uiv(this.addr,e)}function Zw(s,e){s.uniform2uiv(this.addr,e)}function Qw(s,e){s.uniform3uiv(this.addr,e)}function eE(s,e){s.uniform4uiv(this.addr,e)}function tE(s,e,t){const i=this.cache,o=e.length,l=fc(t,o);dn(i,l)||(s.uniform1iv(this.addr,l),pn(i,l));for(let u=0;u!==o;++u)t.setTexture2D(e[u]||M0,l[u])}function nE(s,e,t){const i=this.cache,o=e.length,l=fc(t,o);dn(i,l)||(s.uniform1iv(this.addr,l),pn(i,l));for(let u=0;u!==o;++u)t.setTexture3D(e[u]||T0,l[u])}function iE(s,e,t){const i=this.cache,o=e.length,l=fc(t,o);dn(i,l)||(s.uniform1iv(this.addr,l),pn(i,l));for(let u=0;u!==o;++u)t.setTextureCube(e[u]||A0,l[u])}function rE(s,e,t){const i=this.cache,o=e.length,l=fc(t,o);dn(i,l)||(s.uniform1iv(this.addr,l),pn(i,l));for(let u=0;u!==o;++u)t.setTexture2DArray(e[u]||E0,l[u])}function sE(s){switch(s){case 5126:return Bw;case 35664:return Hw;case 35665:return Vw;case 35666:return Gw;case 35674:return Ww;case 35675:return $w;case 35676:return Xw;case 5124:case 35670:return qw;case 35667:case 35671:return jw;case 35668:case 35672:return Yw;case 35669:case 35673:return Kw;case 5125:return Jw;case 36294:return Zw;case 36295:return Qw;case 36296:return eE;case 35678:case 36198:case 36298:case 36306:case 35682:return tE;case 35679:case 36299:case 36307:return nE;case 35680:case 36300:case 36308:case 36293:return iE;case 36289:case 36303:case 36311:case 36292:return rE}}class oE{constructor(e,t,i){this.id=e,this.addr=i,this.cache=[],this.type=t.type,this.setValue=zw(t.type)}}class aE{constructor(e,t,i){this.id=e,this.addr=i,this.cache=[],this.type=t.type,this.size=t.size,this.setValue=sE(t.type)}}class lE{constructor(e){this.id=e,this.seq=[],this.map={}}setValue(e,t,i){const o=this.seq;for(let l=0,u=o.length;l!==u;++l){const f=o[l];f.setValue(e,t[f.id],i)}}}const Cf=/(\w+)(\])?(\[|\.)?/g;function lg(s,e){s.seq.push(e),s.map[e.id]=e}function cE(s,e,t){const i=s.name,o=i.length;for(Cf.lastIndex=0;;){const l=Cf.exec(i),u=Cf.lastIndex;let f=l[1];const p=l[2]==="]",h=l[3];if(p&&(f=f|0),h===void 0||h==="["&&u+2===o){lg(t,h===void 0?new oE(f,s,e):new aE(f,s,e));break}else{let d=t.map[f];d===void 0&&(d=new lE(f),lg(t,d)),t=d}}}class tc{constructor(e,t){this.seq=[],this.map={};const i=e.getProgramParameter(t,e.ACTIVE_UNIFORMS);for(let o=0;o<i;++o){const l=e.getActiveUniform(t,o),u=e.getUniformLocation(t,l.name);cE(l,u,this)}}setValue(e,t,i,o){const l=this.map[t];l!==void 0&&l.setValue(e,i,o)}setOptional(e,t,i){const o=t[i];o!==void 0&&this.setValue(e,i,o)}static upload(e,t,i,o){for(let l=0,u=t.length;l!==u;++l){const f=t[l],p=i[f.id];p.needsUpdate!==!1&&f.setValue(e,p.value,o)}}static seqWithValue(e,t){const i=[];for(let o=0,l=e.length;o!==l;++o){const u=e[o];u.id in t&&i.push(u)}return i}}function cg(s,e,t){const i=s.createShader(e);return s.shaderSource(i,t),s.compileShader(i),i}const uE=37297;let fE=0;function hE(s,e){const t=s.split(`
`),i=[],o=Math.max(e-6,0),l=Math.min(e+6,t.length);for(let u=o;u<l;u++){const f=u+1;i.push(`${f===e?">":" "} ${f}: ${t[u]}`)}return i.join(`
`)}function dE(s){const e=kt.getPrimaries(kt.workingColorSpace),t=kt.getPrimaries(s);let i;switch(e===t?i="":e===sc&&t===rc?i="LinearDisplayP3ToLinearSRGB":e===rc&&t===sc&&(i="LinearSRGBToLinearDisplayP3"),s){case Hr:case uc:return[i,"LinearTransferOETF"];case Ni:case rh:return[i,"sRGBTransferOETF"];default:return console.warn("THREE.WebGLProgram: Unsupported color space:",s),[i,"LinearTransferOETF"]}}function ug(s,e,t){const i=s.getShaderParameter(e,s.COMPILE_STATUS),o=s.getShaderInfoLog(e).trim();if(i&&o==="")return"";const l=/ERROR: 0:(\d+)/.exec(o);if(l){const u=parseInt(l[1]);return t.toUpperCase()+`

`+o+`

`+hE(s.getShaderSource(e),u)}else return o}function pE(s,e){const t=dE(e);return`vec4 ${s}( vec4 value ) { return ${t[0]}( ${t[1]}( value ) ); }`}function mE(s,e){let t;switch(e){case ly:t="Linear";break;case cy:t="Reinhard";break;case uy:t="OptimizedCineon";break;case fy:t="ACESFilmic";break;case dy:t="AgX";break;case py:t="Neutral";break;case hy:t="Custom";break;default:console.warn("THREE.WebGLProgram: Unsupported toneMapping:",e),t="Linear"}return"vec3 "+s+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}function gE(s){return[s.extensionClipCullDistance?"#extension GL_ANGLE_clip_cull_distance : require":"",s.extensionMultiDraw?"#extension GL_ANGLE_multi_draw : require":""].filter(ca).join(`
`)}function vE(s){const e=[];for(const t in s){const i=s[t];i!==!1&&e.push("#define "+t+" "+i)}return e.join(`
`)}function _E(s,e){const t={},i=s.getProgramParameter(e,s.ACTIVE_ATTRIBUTES);for(let o=0;o<i;o++){const l=s.getActiveAttrib(e,o),u=l.name;let f=1;l.type===s.FLOAT_MAT2&&(f=2),l.type===s.FLOAT_MAT3&&(f=3),l.type===s.FLOAT_MAT4&&(f=4),t[u]={type:l.type,location:s.getAttribLocation(e,u),locationSize:f}}return t}function ca(s){return s!==""}function fg(s,e){const t=e.numSpotLightShadows+e.numSpotLightMaps-e.numSpotLightShadowsWithMaps;return s.replace(/NUM_DIR_LIGHTS/g,e.numDirLights).replace(/NUM_SPOT_LIGHTS/g,e.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,e.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,t).replace(/NUM_RECT_AREA_LIGHTS/g,e.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,e.numPointLights).replace(/NUM_HEMI_LIGHTS/g,e.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,e.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,e.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,e.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,e.numPointLightShadows)}function hg(s,e){return s.replace(/NUM_CLIPPING_PLANES/g,e.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,e.numClippingPlanes-e.numClipIntersection)}const yE=/^[ \t]*#include +<([\w\d./]+)>/gm;function Zf(s){return s.replace(yE,SE)}const xE=new Map;function SE(s,e){let t=St[e];if(t===void 0){const i=xE.get(e);if(i!==void 0)t=St[i],console.warn('THREE.WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',e,i);else throw new Error("Can not resolve #include <"+e+">")}return Zf(t)}const ME=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function dg(s){return s.replace(ME,wE)}function wE(s,e,t,i){let o="";for(let l=parseInt(e);l<parseInt(t);l++)o+=i.replace(/\[\s*i\s*\]/g,"[ "+l+" ]").replace(/UNROLLED_LOOP_INDEX/g,l);return o}function pg(s){let e=`precision ${s.precision} float;
...
#define LOW_PRECISION`),e}function EE(s){let e="SHADOWMAP_TYPE_BASIC";return s.shadowMapType===Jg?e="SHADOWMAP_TYPE_PCF":s.shadowMapType===N_?e="SHADOWMAP_TYPE_PCF_SOFT":s.shadowMapType===ir&&(e="SHADOWMAP_TYPE_VSM"),e}function TE(s){let e="ENVMAP_TYPE_CUBE";if(s.envMap)switch(s.envMapMode){case fo:case ho:e="ENVMAP_TYPE_CUBE";break;case ac:e="ENVMAP_TYPE_CUBE_UV";break}return e}function AE(s){let e="ENVMAP_MODE_REFLECTION";if(s.envMap)switch(s.envMapMode){case ho:e="ENVMAP_MODE_REFRACTION";break}return e}function CE(s){let e="ENVMAP_BLENDING_NONE";if(s.envMap)switch(s.combine){case Zg:e="ENVMAP_BLENDING_MULTIPLY";break;case oy:e="ENVMAP_BLENDING_MIX";break;case ay:e="ENVMAP_BLENDING_ADD";break}return e}function RE(s){const e=s.envMapCubeUVHeight;if(e===null)return null;const t=Math.log2(e)-2,i=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),112)),texelHeight:i,maxMip:t}}function PE(s,e,t,i){const o=s.getContext(),l=t.defines;let u=t.vertexShader,f=t.fragmentShader;const p=EE(t),h=TE(t),m=AE(t),d=CE(t),_=RE(t),y=gE(t),w=vE(l),E=o.createProgram();let x,S,R=t.glslVersion?"#version "+t.glslVersion+`
